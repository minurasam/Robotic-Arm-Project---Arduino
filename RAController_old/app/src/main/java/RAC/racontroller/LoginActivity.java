...
public class LoginActivity extends AppCompatActivity {
    ...
    public void btnLogin_onClick(View view) {
        ...
        } else if (tryLogin(address + "/api", username, password)) {
    ...
    private boolean tryLogin(String address, String username, String password) {
        try {
            Login login = new Login();
            return login.execute(new LoginDetails(address, username, password)).get();
